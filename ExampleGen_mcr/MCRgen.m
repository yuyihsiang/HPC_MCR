            ...
            if (length(pto(n).c)>1 || length(pto(n).k)>1)
                ...
                for l2=1:length(pto(n).k)
                    for l1=1:length(pto(n).c)
                        ...
                        mcr.cases(len*(kkk-1)+1:len*(kkk-1)+len,  numConditions+1) = mcr.cases(1:len,  numConditions+1);
...
end; clear i j k l1 l2 m n name nseed kkk len numConditions seedkkk
